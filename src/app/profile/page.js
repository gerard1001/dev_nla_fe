          ...
          >
            ...
            <g id="SVGRepo_iconCarrier">
              ...
              <path
                ...
                stroke={`${router === "/users" ? "white" : "#1C274C"}`}
                stroke-width="1.5"
                stroke-linecap="round"
                stroke-linejoin="round"
              ></path>{" "}
      ...
      <div className="grid grid-cols-3   gap-3">
        <div className="bg-white p-6 col-span-2 rounded-md ">
          ...
          <div className="flex mb-5">
            <img
              ...
              src="https://switchiify.net.rw/u/assets/img/profile.png"
              className="h-[100px] rounded-fill"
            />
            <div className="px-5">
              <h3 className="text-3xl font-bold text-gray-700">
                {user?.firstname} {user?.lastname} {user ? "" : "Loading..."}
              </h3>
              <p className="text-gray-500 text-lg">
                Email: {user?.email} {user ? "" : "Loading..."}
              </p>
              <p className="text-gray-500 text-lg">
                Phone: {user?.phone} {user ? "" : "Loading..."}
              </p>
              <p className="text-blue-500 text-lg font-bold">
                Role: {user?.role?.label || user?.role}{" "}
                {user ? "" : "Loading..."}
              </p>
              ...
              <button
                style={{ background: "rgba(25, 152, 85, 0.25)" }}
                className="py-[-25px] dark:text-green-900  ml-5 px-[8px] h-[40px]  rounded-full "
              >
                Active
              </button>
        ...
        <div className="bg-white col-span-1 rounded-md p-4 ">
          ...
          <div className="flex items-start mb-6">
            ...
            >
              I confirm with my account deactivation{" "}
            </label>
          </div>
