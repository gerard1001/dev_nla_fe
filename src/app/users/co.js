...
<h2 className="text-2xl">All registered users.</h2>

<div className='ml-auto mr-[-100px]'>
  <button style={{borderRadius:50}} className='bg-blue-700 text-white mx-3  mt-1 hover:bg-blue-600 p-2'>ADD USER</button>
...
<input
  ...
  style={{ width: "30%", border: "2px solid rgb(138, 43, 226,0.7)" }}
/>
</div>
