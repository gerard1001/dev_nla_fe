...
const page = () => {
  return (
    <div>
      ...
      <div className="w-full  z-10  h-full  duration-700" id="notification">
          <div className="2xl:w-full bg-gray-50   p-8  ">
              <div className="flex items-center justify-between">
                  <p tabindex="0" className="focus:outline-none text-3xl font-semibold leading-6 text-gray-800">Notifications</p>
              ...
              <div className="w-full p-3 mt-8 bg-white rounded flex">
                  ...
                  <div className="pl-3">
                      <p tabindex="0" className="focus:outline-none text-sm leading-none"><span className="text-indigo-700">Bruce Ishimwe</span> solved a case  <span className="text-indigo-700">item</span></p>
              ...
              <div className="w-full p-3 mt-4 bg-white rounded shadow flex flex-shrink-0">
                  ...
                  <div className="pl-3 w-full">
                      <div className="flex items-center justify-between w-full">
                          <p tabindex="0" className="focus:outline-none text-sm leading-none"><span className="text-indigo-700">NLA ADMIN</span> added you to the management team: <span className="text-indigo-700">Southern Departament</span></p>
              ...
              <div className="w-full p-3 mt-4 bg-white rounded flex">
                  ...
                  <div className="pl-3">
                      <p tabindex="0" className="focus:outline-none text-sm leading-none"><span className="text-indigo-700">Jackson Dushimimana</span> sent a recommendation letter: <span className="text-indigo-700">Case</span></p>
                      <p tabindex="0" className="focus:outline-none text-xs leading-3 pt-1 text-gray-500">2 hours ago</p>
                  </div>
              </div>
              <div className="w-full p-3 mt-4 bg-red-100 rounded flex items-center">
                  ...
                  <div className="pl-3 w-full flex items-center justify-between">
                      <p tabindex="0" className="focus:outline-none text-sm leading-none text-red-700">Cases kept in trash about to be deleted</p>
              ...
              <div className="w-full p-3 mt-4 bg-white rounded flex">
                  ...
                  <div className="pl-3">
                      <p tabindex="0" className="focus:outline-none text-sm leading-none">New role assigned to your account<span className="text-indigo-700"> #25551</span></p>
                      <p tabindex="0" className="focus:outline-none text-xs leading-3 pt-1 text-gray-500">2 hours ago</p>
                  </div>
              </div>
              ...
              <div className="w-full p-3 mt-6 bg-white rounded flex">
                  ...
                  <div className="pl-3">
                      <p tabindex="0" className="focus:outline-none text-sm leading-none"><span className="text-indigo-700">Bruce</span> sent a new email: <span className="text-indigo-700">Case</span></p>
                      <p tabindex="0" className="focus:outline-none text-xs leading-3 pt-1 text-gray-500">2 hours ago</p>
                  </div>
              </div>
              <div className="w-full p-3 mt-4 bg-white rounded flex">
                  ...
                  <div className="pl-3">
                      <p tabindex="0" className="focus:outline-none text-sm leading-none">New error found<span className="text-indigo-700"> Uploading</span></p>
                      <p tabindex="0" className="focus:outline-none text-xs leading-3 pt-1 text-gray-500">2 hours ago</p>
                  </div>
              </div>
              ...
              <div className="w-full p-3 mt-8 bg-green-100 rounded flex items-center">
                  ...
                  <div className="pl-3 w-full">
                      <div className="flex items-center justify-between">
                          <p tabindex="0" className="focus:outline-none text-sm leading-none text-green-700">Case study sprint completed</p>
